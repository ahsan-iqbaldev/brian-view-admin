...
const Sidebars = () => {
  ...
  return (
    <>
      ...
      <div className="hidden lg:block relative flex flex-col bg-clip-border bg-white text-gray-700 h-[calc(100vh)] w-full max-w-[17rem] p-4 shadow-xl shadow-blue-gray-900/5">
        <nav className="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
          ...
          <Link to="/posting" onClick={closeSidebar}>
            <div
              role="button"
              tabIndex="0"
